...
import { Web3ModalProvider } from '../lib/wallets/Web3ModalProvider'
import './globals.css'
...
export const metadata: Metadata = {
  title: 'SynapseWorth | Verifiable Intelligence. Tokenized Potential.',
  ...
  generator: 'v0.app',
  keywords: ['AI', 'Hedera', 'blockchain', 'knowledge marketplace', 'tokenization', 'agents'],
  icons: {
    icon: [
      {
